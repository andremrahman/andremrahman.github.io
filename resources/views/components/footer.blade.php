<footer class="bg-inherit w-full font-montserrat border-t border-t-white">
    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="w-full md:min-w-1/3 md:px-4 md:border-x mb-8 md:mb-0">
        ...
        <div class="flex">
          ...
          <p class="ml-2 text-sm">+62 8113232102</p>
        </div>
        ...
        <div class="flex items-center">
          ...
          <p class="mb-0.5 ml-2 text-sm">info@gajahmada.asia</p>
        </div>
        ...
        <div class="flex items-center">
          ...
          <p class="mb-0.5 ml-2 text-sm">ceo@gajahmada.asia</p>
        </div>
