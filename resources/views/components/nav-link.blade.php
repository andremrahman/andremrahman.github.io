...
<a {{ $attributes }} aria-current="{{ $active ? 'page' : false }}"
  ...
  <span
    class="absolute w-0 h-0 transition-all duration-500 ease-out bg-zinc-200/50 rounded-full group-hover:w-56 group-hover:h-56 group-active:w-56 group-active:h-56"></span>
