<x-layout>
  ...
  @section('meta_description', Str::squish('PT Gajahmada Karya Mandiri is a full-service general contractor leading the
    planning and construction of major infrastructure, commercial buildings, and residential projects.'))
    ...
    <section id="cta" class="relative min-h-[50vh] overflow-x-hidden flex items-center font-oswald">
      <img src="{{ asset('img/cta.webp') }}" alt="call to action"
